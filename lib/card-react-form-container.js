    ...
    validateInput: function(inputName, inputValue) {
      ...
      switch (inputName) {
        case inputsNames["expiry"]:
          ...
          currentInputsValidationClass[inputsNames["expiry"]] = this.getInputValidationClass(Stripe.validateExpiry(objVal.month, objVal.year));
          break;
        case inputsNames["cvc"]:
          currentInputsValidationClass[inputsNames["cvc"]] = this.getInputValidationClass(Stripe.validateCVC(inputValue));
          break;
        case inputsNames["number"]:
          currentInputsValidationClass[inputsNames["number"]] = this.getInputValidationClass(Stripe.validateCardNumber(inputValue));
          break;
